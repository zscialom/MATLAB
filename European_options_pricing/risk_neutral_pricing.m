function [ option_price ] = risk_neutral_pricing( u,K,r,T,Binomialtree,type )
...
for k=T:-1:1
        length_vector = length(Binomialtree(:,k)) - sum(isnan(Binomialtree(:,k))); % Just where there are values
        a=0;
